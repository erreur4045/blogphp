...
<div class="main">
    <div class="container">
        ...
        <p class="btn btn-info"><a href="index.php?action=listAllPosts">Retour à la liste des articles</a></p>
            ...
            <div class="row">
                ...
                <div class="card flex-md-row mb-4 box-shadow h-md-250">
                    <div class="card-body d-flex flex-column align-items-start ">
                            <p><strong><?= 'Par ' . ucfirst(htmlspecialchars($comment_data->getAutor())) ?></strong><em>le <?= $comment_data->getComment_date() ?>
                            </em></p>
