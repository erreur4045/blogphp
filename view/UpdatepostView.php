...
<div class="container">
    <div class="row">
        <div class="addnewpost">
            <form action="index.php?action=validupdatepost&id=<?php echo $_GET['id']?>" class="form_contact" method="post">
                <div class="form_in">
                    ...
                    <div class="form_in">
                        ...
                        <textarea name="content" class="form-control"required><?= $data_view['content']?></textarea>
                        <br>
