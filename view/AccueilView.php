    ...
    <div class="main">
        ...
        <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
            <div class="col-md-6 px-2">
                ...
                <p class="lead my-3">Je me presente je suis Maxime THIERRY, ce site est le mon premier site en
                    php/POO</p>
                <p class="lead my-3">Ma devise: Sapere aude</p>
                <p class="lead mb-0"><a href="index.php?action=bio" class="text-white font-weight-bold">Lire ma bio</a>
                </p>
            </div>
        </div>
        <div class="container">
            <div class="d-flex justify-content-center">
                <div class="row">
                    <a href="https://github.com/erreur4045" target="_blank"><i class="fab fa-github fa-4x"></i></a>
